...
title: "Assignment #11"
---
# Assignment #11 - Due Saturday, May 9th at 11PM 
...
* [Extra Credit (for midterm exams)](#part3)
...
* Read in the file specified in <code>args[0]</code> (the <code>.csv</code> file) using a combination of a <code>File</code> object and a <code>Scanner</code> object
	...
	* extra the data from each line (hint: maybe <code>split</code> would be helpful here!) ... determine which column the first, last and contribution amount appears
...
* Once you've finished reading in all of the data, __sort the data by descending order of average contribution__
	...
	* or... if you're interested in trying to implement <code>Comparable</code>, a lengthy way of doing this would be to:
...
## (5 percentage points - extra credit points from 2nd midterm) Part 3 - Extra Credit
...
* The extra credit counts as a __maximum of 5%__ on your lower midterm exam grade
	* The __extra credit from midterm #2 will be subtracted from this__
	* __If you did 10% better on your 2nd midterm, you are not eligible for this extra credit__
